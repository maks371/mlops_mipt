...
from face_recognition.train_model import train_epochs, cos_face_loss
...
def train_and_save(data_folder, save_folder):
    ...
    history = train_epochs(model, opt, loss, epochs_number, train_loader, val_loader, m=0.35, s=16)
